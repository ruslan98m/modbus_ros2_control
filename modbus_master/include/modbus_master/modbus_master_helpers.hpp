...
double readRegisterValue(modbus_t* ctx,
                        const modbus_hw_interface::ModbusRegisterConfig& reg);

bool writeRegisterValue(modbus_t* ctx,
                        const modbus_hw_interface::ModbusRegisterConfig& reg,
                        double value);

void setResponseTimeout(modbus_t* ctx,
                        const modbus_hw_interface::ModbusDeviceConfig& dev);
